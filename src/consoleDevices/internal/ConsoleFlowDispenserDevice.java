...
public class ConsoleFlowDispenserDevice extends ConsoleDevice implements DispenserDevice {

    private ArrayList<ContainerDevice> containerDevices;

    public ConsoleFlowDispenserDevice(String name) {
        super(name, DeviceType.FlowDispenser);
