...
public class ConsoleMaterialDispenserDevice extends ConsoleDevice implements DispenserDevice {

    private ArrayList<ContainerDevice> containerDevices;

    public ConsoleMaterialDispenserDevice(String name) {
        super(name, DeviceType.MaterialDispenser);
